...
| 方法 | 行号 | 说明 |
|------|------|------|
| `_buildActionButton` | 119-154 | 操作按钮（相机/相册） |
| `_buildSearchButton` | 157-189 | 搜索按钮（渐变样式） |
| `_buildNumberSection` | 192-266 | 编号区域容器 |
| `_buildNumberHeader` | 269-314 | 编号区域标题行 |
| `_buildNumberItem` | 317-441 | 单个编号输入项 |
| `_buildPaginationButtons` | 444-487 | 分页按钮 |
